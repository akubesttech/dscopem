...
if(isset($_POST['st_mat'])){
    ...
    $st_mat = $_POST['st_mat'];
    $up[]= update_status($condb,$_POST['id_status'],$st_mat,"Local Governmen",$_POST['ld_rem']??null);
    ...
    $up[]= update_status($condb,$_POST['bc_status'],$st_mat,"Birth Certifica",$_POST['bc_rem']??null);

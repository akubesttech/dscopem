...
$femail = $dform_get2['email']; $fphone = $dform_get2['phone']; $fprog = $dform_get2['prog'];$fsession = $dform_get2['session']; $pamount = $dform_get2['paid_amount'];
...
<font color="green" size="4">Your <?php echo getfeecat($feename); ?> Payment was Successful,<br></font> <?php } ?>
</p>
                </div>
	...
	<!--	<form name="register2" action="https://voguepay.com/pay/" method="post" enctype="multipart/form-data" id="register2"> --!>
	 <form name="register2" action="finitialize.php" method="post" enctype="multipart/form-data" id="register2">
        ...
        <table  border="1">
       <tr class="row1">
  <td width="20%" colspan="1" height="15"><strong> Application Number:</strong></td>
    <td width="31%" colspan="4"><?php echo $appNo; ?></td>
    </tr>
  <tr class="row2">
